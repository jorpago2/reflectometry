...
test("saved fits restore complete v7 data and legacy substrate units", () => {
  ...
  const base = { stack: [{ id: "layer1", name: "Layer", opticalModel: "constant", parameters: { thicknessNm: 100, n: 2, k: 0.1 } }], substrate: { refractiveIndex: { n: 1.5, k: 0.01 }, thicknessUm: 1000, incidence: "film" }, gains: { reflectance: 1, transmittance: 1 } };
